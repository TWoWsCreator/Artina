        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'artist',
                    models.CharField(
                        help_text='Введите фамилию, имя и отчество художника '
                        'через пробел',
                        max_length=50,
                ...
                (
                    'years_of_life',
                    models.CharField(
                        help_text='Введите год рождения и смерти художника '
                        'через тире. Пример: 1899-1977',
                        max_length=10,
